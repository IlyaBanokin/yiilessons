<?php
/** @var \app\models\Products $offers
 *
 */
                        ...
                        <div class="menu-details br-red">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <div class="menu-list-item">
                                        <!-- Icon -->
                                        <i class="fa fa-angle-right"></i> <a href="index.html#">Praising
                                            Pain</a>
                                        <!-- Price badge -->
                                ...
                                <li>
                                    <div class="menu-list-item">
                                        <!-- Icon -->
                                        <i class="fa fa-angle-right"></i> <a href="index.html#">Exception
                                            Tint</a>
                                        <!-- Price badge -->
                                ...
                                <li>
                                    <div class="menu-list-item">
                                        <!-- Icon -->
                                        <i class="fa fa-angle-right"></i> <a href="index.html#">Laborious
                                            Rhys</a>
                                        <!-- Price badge -->
                        ...
                        <div class="menu-details br-green">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <div class="menu-list-item">
                                        <!-- Icon -->
                                        <i class="fa fa-angle-right"></i> <a href="index.html#">Fried
                                            Chicken</a>
                                        <!-- Price badge -->
                                        <span class="pull-right">$29</span>
                                        <div class="clearfix"></div>
                                ...
                                <li>
                                    <div class="menu-list-item">
                                        <!-- Icon -->
                                        <i class="fa fa-angle-right"></i> <a href="index.html#">Chicken
                                            Curie</a>
                                        <!-- Price badge -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        <!-- Image -->
                        <a href="index.html#">
                            <?= Html::img('@web/img/dish/logo.png', ['alt' => 'Наш логотип']) ?>
                        </a>
                        ...
                        <ul class="slides">
                            <li>
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <blockquote>
                                        <!-- Paragraph -->
                                        <p>Sed ut perspiciatis unde omnis iste natus error sitvolu accusative
                                            ntium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
                                            illo inventore veritatis et quasi architecto beatae vitae dicta.</p>
                                    </blockquote>
                                    <!-- Heading with image -->
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <blockquote>
                                        ...
                                        <p>At vero eos et accusamus et iusto odio dignis simos ducimus qui bland
                                            itiis praes entium volup tatum deleniti atque corrupti quos dolores
                                            et quas molestias excepturi sint occaecati cupiditate non
                                            laboratory.</p>
                                    </blockquote>
                                    <!-- Heading with image -->
                                    <h4><img class="img-responsive img-circle" src="img/user.jpg" alt=""/>
                                        Katrina Doe<span>, your designation</span></h4>
                                    <div class="clearfix"></div>
                                </div>
                            </li>
                        </ul>
